<?php
	...
	wp_enqueue_style('jobboard-style-listing_style_grid', wp_jobboard_URLPATH . 'admin/files/css/listing_style_grid.css');
...
<?php
	...
	if( isset($_REQUEST['employer'])){ 
		$author = sanitize_text_field($_REQUEST['employer']);
		$args['author']= (int)sanitize_text_field($author);		
	}

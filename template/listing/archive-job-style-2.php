<?php
	...
	wp_enqueue_style('jobboard-style-listing_style_5', wp_jobboard_URLPATH . 'admin/files/css/listing_style_5.css');
...
<style>	
	.item{
	background:<?php echo esc_html($dir5_content_color);?>;
	}
	.facet-parent {
						...
						<div class="row px-0 m-0">
							<div class="form-group col-sm-12 mt-4 mt-md-5 px-0">
								<div class="inner-addon left-addon mx-0 d-flex align-items-center">
									...
									<input type="text"  value="<?php echo esc_attr($dirsearch);?>" class="" id="dirsearch" name="dirsearch" placeholder="<?php  esc_html_e('Search','jobboard');?>"/>
									<input type="hidden"  value="<?php echo esc_attr($dirsearchtype);?>"  id="dirsearchtype" name="dirsearchtype"/>
								</div>
							</div>
						</div>
						<input id="submitbtn" type="submit" name="top-search" value="<?php  esc_html_e('Search','jobboard');?>" class="btn btn-block">
					</form>
					<div class="filter">
						<?php    esc_html_e('Filter Search','jobboard');?> <i class="fas fa-align-left"></i>
					</div>
					<div id=facets></div>
				</div>
...
<?php
	...
	wp_enqueue_script('iv_directory-ar-script-27', wp_jobboard_URLPATH . 'admin/files/js/archive-listing5.js');
